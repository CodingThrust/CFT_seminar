...
#table(
  ...
  [$chevron.l (z_1, overline(z)_1) phi(z_2, overline(z)_2) chevron.r = frac(C,(z_1 - z_2)^(Delta + s) (overline(z)_1 - overline(z)_2)^(Delta - s))$],
...
$ |phi_(text(o u t)) chevron.r  = lim_(z, overline(z) arrow.r infinity) phi(z, overline(z) ) |0 chevron.r = lim_(z, overline(z) arrow.r 0) phi(1/z, 1/overline(z) ) |0 chevron.r$
...
We conclude that 
$ L_0|h,overline(h) chevron.r = h|h, overline(h) chevron.r,  overline(L)_0|h,overline(h) chevron.r = overline(h)|h, overline(h) chevron.r $
== Descendants fields
...
in terms of $Delta$ and $s$, color-coded by conformal tower, showing the location of the primary states $|I chevron.r$, $|sigma chevron.r$and $|epsilon chevron.r$, and the energy-momentum states $|T chevron.r$and $ | overline(T) chevron.r$. Note: We shift points horizontally from their allowed values (S is quantized) to avoid overlaps and better show degeneracies in this and subsequent figures.],
) <Ising_spectrum>
